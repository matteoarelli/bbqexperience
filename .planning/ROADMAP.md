...
**Success Criteria** (what must be TRUE):
  1. `/en/reviews/`, `/it/reviews/`, `/es/reviews/` each expose brand, category, price-bucket (<€300, €300–€800, €800–€1500, >€1500), and score-threshold (6+, 7+, 8+) filters with live count badges per option.
