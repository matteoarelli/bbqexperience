...
- [ ] 17-04-PLAN.md — Schema markup audit (FAQPage/HowTo/speakable) + sweep_pages.py --check schema + per-agent Telegram coverage + cron_registry.md canonical
...
| 17. GSC-Driven Content Pipeline | v1.1 | 3/4 | Executing  | — |
