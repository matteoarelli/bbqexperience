...
**Plans**: 4 plans
Plans:
- [ ] 17-01-PLAN.md — Foundation: lib/gsc_client.py + lib/indexnow_client.py + lib/atomic_io.py + pytest scaffold + content_generator publish-hook indexing
...
| 17. GSC-Driven Content Pipeline | v1.1 | 0/4 | Planned    | — |
