...
- **Global scope**: `C:/Users/Matteo/Desktop/Progetti/bbqexperience/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/Matteo/Desktop/Progetti/bbqexperience/.claude/notes/`)
...
2. Glob `C:/Users/Matteo/Desktop/Progetti/bbqexperience/.claude/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/Matteo/Desktop/Progetti/bbqexperience/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/Matteo/Desktop/Progetti/bbqexperience/.claude/notes/` — works in any directory
